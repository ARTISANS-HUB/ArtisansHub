...
const AddbookServices = async (req, res, next) => {
  ...
  try {
    ...
    if (results) {
      ...
      //send sms
      const message = 'Hello ' + created_by + ', Your home services booking was success. Details Schedule Time : ' + schedule_time + ' Schedule_date : ' + schedule_date + ' location :' + location +' From :'+ SERVER_NAME;
